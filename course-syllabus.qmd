...
| Office hours: M 3:00-5:00 p.m., W 1:00-3:00 p.m.
| Credit Hours: 3.0
<br>
To speak with me during office hours, please schedule an appointment via [Calendly](https://calendly.com/emmanuel-teitelbaum/15min).
...
You may use AI tools—such as ChatGPT, Claude, Gemini, and Copilot—to support your learning in this course. These tools can help you explain a concept, clarify an error message, walk through how a function works, or help you debug code that isn't running correctly.

That said, there is an important distinction between using AI as a learning support versus using it to replace learning entirely. The goal of this course is for you to develop genuine skills in data visualization and R programming. Submitting AI-generated work as your own defeats that purpose.

### Guidelines

Follow these principles when using AI tools:

-   **Try first**: Before turning to an AI tool, consult the course materials, lecture videos, and readings. For labs, work through the guided hints before seeking AI assistance. For homework, it is appropriate to consult AI if you are genuinely stuck.

-   **Use AI as a consultant, not a ghostwriter**: Asking an AI tool to explain how a function works, debug code that isn't running, or decipher an error message is a legitimate use. Asking it to complete your assignments for you is not.

-   **Think critically**: AI tools make mistakes. They hallucinate functions, write syntactically incorrect code, and sometimes give confidently wrong answers. You are responsible for understanding and verifying any code you submit.

-   **Acknowledge your use**: If you use an AI tool in completing an assignment, note this in your submission and confirm that the tool was used in an advisory capacity rather than to generate your final product.
...
-   **Discord:** We will discuss course topics further through the Discord. Feel free to post your questions about technical issues or to respond helpfully to questions from other students. 
...
-   **Final Project:** You will develop your own interactive data visualization application as your final project during Week 6.  
...
For any non-excused late assignments, a penalty of one percentage point per day (deduction) will be applied to the students' final score fo the assignment.
...
Communication in our course is essential; clearing up questions earlier than later is a good practice, so please don't hesitate to reach out to me. In any mode of communication used in our course, all of us will follow the rules of netiquette discussed below.
...
I will respond to emails within 48 hours on weekdays and by the next business day over weekends and holidays. I will provide feedback on assignments within five business days.

### Technical issues

For technical coding questions, please reach out in person during office hours or post on Discord rather than emailing me. Note that email is not an effective medium for diagnosing and solving coding problems. Debugging is also one of the most legitimate uses of AI tools in this course. If your code throws an error and you cannot determine why, consulting an AI is a reasonable first step before reaching out. You can post general course-related questions to our Discord server; please post there first rather than emailing me directly. However, if you have a question that is more personal in nature (e.g., grades), please email me directly to set up an appointment.
